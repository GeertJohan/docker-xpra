...
# install apt tools
RUN sudo apt-get update && sudo apt-get -y install --no-install-recommends software-properties-common
...
RUN sudo apt-get update && sudo apt-get -y install --no-install-recommends xpra
